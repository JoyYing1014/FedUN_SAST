...
def seperate_batch_data(input_data, target_data, batch_size):
    batch_data_indices_list = fs.DataLoader.separate_list(list(range(len(target_data))), batch_size)
    local_data = []
...
def seperate_batch_data_single(data, batch_size):
    ...
    batch_data_indices_list = fs.DataLoader.separate_list(list(range(len(data))), batch_size)
    local_data = []
    for batch_data_indices in batch_data_indices_list:
